...
const NAV_ITEM_CLASSES = "inline-flex items-center gap-2.5 rounded-sm px-3 py-2.5 font-bold text-muted-foreground no-underline transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground max-md:justify-center";
