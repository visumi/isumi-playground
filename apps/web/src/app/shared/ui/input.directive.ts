...
const BASE_CLASSES = "w-full rounded-sm border border-input bg-background text-foreground transition-colors placeholder:text-muted-foreground hover:border-ring/60 focus-visible:border-primary/70 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-60";
